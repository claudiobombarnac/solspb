...
public class StrategyProcessor
{
    ...
    public StrategyProcessor(TaskManager taskManager, IStrategy strategy, boolean fullAccessGranted)
    {
    ...
    public Future executeStop(TaskManager.StopCallable callable)
    {
