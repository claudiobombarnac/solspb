...
{
    public TesterFeedDataProvider(String cacheName, ICurvesProtocolHandler curvesProtocolHandler, IOrdersProvider ordersProvider)
        throws DataCacheException
    {
        super(cacheName, true, ordersProvider, null);
    	createFeedDataProvider(cacheName, curvesProtocolHandler, null);
    ...
    {
        return FeedDataProvider.getDefaultInstance();
    }
  ...
  public synchronized TickData getLastTick(Instrument instrument) {
	  return this.lastTicks[instrument.ordinal()];
  }
