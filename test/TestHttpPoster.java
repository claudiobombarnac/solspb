...
//        System.out.println(result);
        String result = FinamDataLoader.loadData(new GregorianCalendar(2011, 1, 1), new GregorianCalendar(), FinamDataLoader.Market.MICEX_STOCKS, "SBER", Period.DAY, Format.DTOHLCV);
        System.out.println(result);
